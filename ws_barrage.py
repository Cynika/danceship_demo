...
from util import proto


class BiliClient:
    def __init__(self, bar_que, roomId, key, secret, host='live-open.biliapi.com'):
        self.bar_que = bar_que
        self.roomId = roomId
        self.key = key
        self.secret = secret
        self.host = host
    ...
    def websocketInfoReq(self, postUrl, params):
        ...
        r = requests.post(url=postUrl, headers=headerMap, data=params, verify=True)
...
if __name__ == '__main__':
    try:
        ...
        cli = BiliClient(
            queue,
            roomId=21013446,
            key="k6C8phgpxl634AL9yJp5LBpi",
            secret="J7rFC6XFmzGdQ8P73gz0DXjzaTGvgp",
